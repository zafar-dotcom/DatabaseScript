...
declare
  v_trn_id           trn_code.trn_id%type := 401;   --next value to trn_id
  v_description      varchar2(100) := 'Cashout change status through file upload';
  v_trn_short_desc   varchar2(100) := 'Cashout change status through file upload';
  v_menu_label       varchar2(100) := 'Status Change Cashout - Batch';
  v_menu_url         varchar2(100) := '/admin/ChangeCashoutPaymentStatusBatch';
...
begin
  ...
  values (46, v_trn_id ); --Cashout get this from module table
