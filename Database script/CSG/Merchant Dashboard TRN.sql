...
declare
  v_trn_id           trn_code.trn_id%type := 406;
  v_description      varchar2(100) := 'Merchant Dashboard';
  v_trn_short_desc   varchar2(100) := 'Merchant Dashboard';
  v_menu_label       varchar2(100) := 'Merchant Dashboard';
  v_menu_url         varchar2(100) := '/Reports/MerchantDashboard';
