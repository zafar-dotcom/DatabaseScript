...
declare
  v_trn_id           trn_code.trn_id%type := 341;
  v_description      varchar2(100) := 'Repush Merchant Settlements';
  v_trn_short_desc   varchar2(100) := 'Repush Merchant Settlements';
  v_menu_label       varchar2(100) := 'Repush Merchant Settlements';
  v_menu_url         varchar2(100) := '/Admin/GetRePushInstructions';
  v_priority_level   trn_code.priority_level%type := 200;
  v_trn_module_code  trn_module.module_code%type := 55;--Dashboard  from module table
begin
